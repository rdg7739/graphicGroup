...
static GLfloat   tb_lastposition[3];
 ...
 GLfloat   tb_angle = 0.0;//xmd made these not static
 GLfloat   tb_angleX = 0.0;//xmd made these not static
 GLfloat   tb_angleZ = 0.0;//xmd made these not static
 GLfloat   tb_axis[3];
...
tbMotion(int x, int y, int button)
{
  ...
  tdx = dx = current_position[0] - tb_lastposition[0];
  tdy = dy = current_position[1] - tb_lastposition[1];
